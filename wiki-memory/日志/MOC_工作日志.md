...
| 2026-09-24 | test | - | archived | launch-button-keycap-test-contract | [[日志/2026-09-24-协调按钮键帽字号与E2E几何断言.md|协调按钮键帽字号与 E2E 几何断言]] |
...
| 2026-09-19 | maintenance | - | archived | task-workspace-maintainability | [[日志/2026-09-19-任务监控与记录深度维护.md|任务监控与记录深度维护]] |
...
| 2026-09-18 | ui | - | archived | rearrange-history-format-and-parameter-columns | [[日志/2026-09-18-重排历史格式与参数列.md|重排历史格式与参数列]] |
| 2026-09-18 | ui | - | archived | regroup-history-cards-and-live-task-monitor | [[日志/2026-09-18-重排历史归档与任务监控信息.md|重排历史归档与任务监控信息]] |
| 2026-09-18 | ui | - | archived | complete-history-rules-and-align-progress | [[日志/2026-09-18-补齐历史分隔与对齐双进度.md|补齐历史分隔与对齐双进度]] |
...
| 2026-09-18 | ui | - | archived | appearance-controls-and-theme-fidelity | [[日志/2026-09-18-修正主题一致性与布局直接调节.md|修正主题一致性与布局直接调节]] |
